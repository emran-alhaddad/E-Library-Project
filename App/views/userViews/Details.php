            ...
            <main class="presentations">
                <div class="container">
                    ...
                    <div class="card">
                        <div class="header" style="height: 85%;">
                            <img id='boxImage' src="images/Books/Book1.jpg" height="100%" onclick="callImage(this);">
                        </div>
                        <div class="body">
                            <div class="slider">
                                <div class="image">
                                    <img class="slideImage switch__" src="images/Books/Book2.jpg" onclick="switchImage(this,'boxImage');">
                                </div>
                                <div class="image">
                                    <img class="slideImage switch__" src="images/Books/Book3.jpg" onclick="switchImage(this,'boxImage');">
                                </div>
                                <div class="image">
                                    <img class="slideImage switch__" src="images/Books/Book4.jpg" onclick="switchImage(this,'boxImage');">
                                </div>
                                <div class="image">
                                    <img class="slideImage switch__" src="images/Books/Book5.jpg" onclick="switchImage(this,'boxImage');">
                                </div>
                                <div class="image">
                                    <img class="slideImage switch__" src="images/Books/Book1.jpg" onclick="switchImage(this,'boxImage');">
                                </div>
                            </div>
                        </div>
                        <!-- Navigation arrows -->
                        ...
                        <div class="card">
                            ...
                            <div class="footer">
                                <div class="row">
                                    ...
                                    <button>
                                        <img src="icons/Transfere.png" alt="">
                                        مقارنة
                                    </button>
                ...
                <div class="container">
                    <div class="card card2">
                        <div class="header">
                            <img src="images/Books/Book1.jpg" width="100" alt="" srcset="">
                        </div>
                        <div class="body">
                            <h1>كبرياء وهوى</h1>
