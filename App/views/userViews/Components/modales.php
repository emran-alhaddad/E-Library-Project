    ...
    <div id="sign-in">
        ...
        <form action="/admin/" method="GET">
            ...
            <hr>
            <input class="" type="text" onkeyup="validateName(this);" id="fullName" name="" placeholder="البريد الإلكتروني أو رقم الجوال">

            <div class="passDiv">
                <a href="#">نسيت ؟</a>
                <input class="input" type="password" onkeyup="validatePassword(this);" id="password" name="" placeholder="كلمة السر">
            </div>
