...
<?php require_once("Components/header.php"); ?>
    ...
    <?php require_once("Components/carosel.php"); ?>
        ...
        <section class=" categories hide">
            ...
            <div class="container slider">
                <a class="simpleCard" href="#sec1">
                    <img src="icons/svgexport-45.svg" alt="" srcset="">
                    <h2>دين</h2>
                </a>

                <a href="#sec2" class="simpleCard">
                    <img src="icons/svgexport-41.svg" alt="" srcset="">
                    <h2>تاريخ</h2>
                </a>

                <a href="#sec6" class="simpleCard">
                    <img src="icons/svgexport-39.svg" alt="" srcset="">
                    <h2>روايات</h2>
                </a>

                <a href="#sec3" class="simpleCard">
                    <img src="icons/svgexport-42.svg" alt="" srcset="">
                    <h2>سياسة</h2>
                </a>

                <a href="#sec4" class="simpleCard">
                    <img src="icons/svgexport-44.svg" alt="" srcset="">
                    <h2>اقتصاد</h2>
                </a>

                <a href="#sec5" class="simpleCard">
                    <img src="icons/svgexport-46.svg" alt="" srcset="">
                    <h2>طبخ</h2>
                </a>

                <a href="#" class="simpleCard">
                    <img src="icons/svgexport-47.svg" alt="" srcset="">
                    <h2>تربية</h2>
                </a>
            </div>
        </section>
        ...
        <section class="adds hide">
            ...
            <div>
                <img src="images/Adds.jpg" width="100%" alt="">
            </div>
        </section>
