    ...
    <?= require_once("Components/navbar.php"); ?>
        <?= require_once("Components/header.php"); ?>
                                    ...
                                    <div class="container-xl">
                                        <div class="row">
                                            ...
                                            <div class="col d-flex flex-row justify-content-end">
                                                <a href="#" class="btn btn-secondary" data-toggle="modal" data-target="#editBook"><i class="fa fa-edit"></i> <span>Edit This Book</span></a>
                                                <?php if($params['data'][0]->is_active) {?>
                                        ...
                                        <div  class="row <?= $params['data'][0]->is_active ? '' : 'table-danger' ?>">
                                            <div class="col-md-5 col-sm-12">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="card">
                                                            <img src="/uploads/images/books/<?= $params['data'][0]->image ?>" alt="" class="card-img-top">
                                                            <div class="card-body">
                                                                <h5 class="card-title"><?= $params['data'][0]->title?></h5>
                                                                <p class="card-text">
                                                            ...
                                                            <div class="card-footer">
                                                                <p class="card-text">
                                                                    Book Price: $<?= $params['data'][0]->price?>
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-7 col-sm-12">
                                                <div class="row">
                                                    <div class="col mb-5">
                                                        <div class="mb-3 ">
                                                            <h4>Book Title:</h4>
                                                            <p><?= $params['data'][0]->title?></p>
                                                            <h4>Product Price:</h4>
                                                            <p>$<?= $params['data'][0]->price?></p>
                                                        </div>
                                                        ...
                                                        <table class="table table-striped">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $params['data'][0]->pages_number?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Category</th>
                                                                    <td><?= $params['data'][0]->category?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Author</th>
                                                                    <td><?= $params['data'][0]->author?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Publisher</th>
                                                                    <td><?= $params['data'][0]->publisher?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Quantity</th>
                                                                    <td><?= $params['data'][0]->quantity?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Formate</th>
                                                                    <td><?= $params['data'][0]->format?></td>
                                                                </tr>
                                                                <tr >
                                                                    <th scope="row">Status</th>
                                                                    <td><?= $params['data'][0]->is_active?"Avaliable":"Not Allowed"?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
            ...
            <?= require_once("Components/scripts.php"); ?>
                ...
                <!-- Edit Book Module  -->
                <div class="modal fade show" id="editBook" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog">
                            ...
                            <form method="post" action="/" enctype="multipart/form-data">
                                ...
                                <option value="4"> Formate 4</option>
                                        ...
                                        <div class="col-4">
                                            <!-- Form Group (State)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputBookState">Book State </label>
                                                <select class="form-control" name="is_active" id="inputBookState" required>
                                ...
                                <option value="0"> Not Active</option>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="description" id="inputBookDescription" required cols="30" rows="5" style="resize: none;">
                            </textarea>
        ...
        <form action="/admin/deleteBook" id="deleteForm" method="post">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <input type="hidden" name="id" value="<?= $params['data'][0]->id?>" id="deleteBookId">
        ...
        <form action="/admin/restoreBook" id="restoreForm" method="post">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <input type="hidden" name="id" value="<?= $params['data'][0]->id?>" id="restoreBookId">
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
